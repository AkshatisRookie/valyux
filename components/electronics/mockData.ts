...
/**
 * Local mock data used as a fallback when the backend is offline.
 * This mirrors the normalized shape the backend returns.
 * Replace with API calls when Flipkart Affiliate + Amazon PA-API are wired.
 */
...
export const FEATURED_IDS = ['e1', 'e5', 'e8', 'e11', 'e13', 'e17', 'e3', 'e15'];
